...
export class FacebookService {
    ...
    setData(request: any) {
        ...
        template.preference.shareToFacebook = true;
        template.socialNetworkConnect.facebook.fbId = profile.socialId.facebookId;
        template.socialNetworkConnect.facebook.connected = true
